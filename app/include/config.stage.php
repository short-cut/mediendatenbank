...
$baseurl="http://10.50.2.90"; # The 'base' web address for this installation. Note: no trailing slash
...
$spider_password="YVe6yHAWEgez"; # The password required for spider.php - IMPORTANT - randomise this for each new installation. Your resources will be readable by anyone that knows this password.
...
$email_from_user=true; #enable user-to-user emails to come from users address by default (for better reply-to), with the user-level option of reverting to the system address
...
$applicationname="Mediendatenbank der DGE e.V."; # The name of your implementation / installation (e.g. 'MyCompany Resource System')
...
$defaultlanguage="de"; # default language, uses ISO 639-1 language codes ( en, es etc.)
...
$disk_quota_notification_email='it@dge.de';
